...
def clear():
    global equation
    equation = ""
    result_screen.config(text=equation)
...
result_screen = Label(root,width=25,height=2,text="" , font =("arial", 30))
result_screen.pack()


Button(root,text='AC', width = 5 , height = 1 , font = ('arial',30,'bold'),bd=1 , fg = '#fff',bg = "#3fb0da", command=lambda:clear()).place(x =10 ,y=100)
...
Button(root,text='=', width = 5 , height = 3 , font = ('arial',30,'bold'),bd=1 , fg = '#fff',bg = "#e67e2f" , command= lambda: calculate()).place(x =430 ,y=400)
